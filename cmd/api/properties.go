...
func (app *Application) GetProperties(c echo.Context) error {
	...
	// 	return err
	// }
	newPrms := repo.SearchParams{
		StMakeenvelope:   dd.Boundingbox[0],
		StMakeenvelope_2: dd.Boundingbox[1],
		StMakeenvelope_3: dd.Boundingbox[2],
		StMakeenvelope_4: dd.Boundingbox[3],
	}
	res, err := app.dd.Search(ctx, newPrms)
	if err != nil {
		return err
	}
